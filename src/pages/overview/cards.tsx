...
const Cards = () => {
  return (
    <div className="flex flex-wrap items-center gap-4 p-6">
      <div className="flex min-w-[200px] flex-1 flex-col rounded-[8px] border px-4 py-3">
        ...
        <div className="flex items-center gap-2 text-[#14532D]">
          <MoveUpRight size={18} />
          <p className="text-xs">4% increase </p>
        </div>
      </div>

      <div className="flex min-w-[350px] flex-1 flex-col rounded-[8px] border px-4 py-3">
        ...
        <div className="flex items-center gap-2 text-[#7A2100]">
          <MoveUpRight size={18} />
          <p className="text-xs">4% increase </p>
        </div>
      </div>
      ...
      <div className="flex min-w-[350px] flex-1 flex-col rounded-[8px] border px-4 py-3">
        ...
        <div className="flex items-center text-[#1A1A1A]">
          <h3 className="mx-auto w-fit">
            <span className="text-[21px] font-semibold">720</span>{" "}
